...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        String newWhatsapp = request.getParameter("whatsapp") != null ? request.getParameter("whatsapp") : "";
        String newDescription = request.getParameter("description") != null ? request.getParameter("description") : "";
        ...
        try {
            ...
            updateSql = "UPDATE Profile SET description = ? WHERE Contact_ID = " +
            ...
            if (filePart != null && filePart.getSize() > 0) {
                ...
                updateSql = "UPDATE Profile SET Personal_Image = ? WHERE Contact_ID = " +
                           "(SELECT id FROM Contact WHERE email = ?)";
                updateStmt = updateConn.prepareStatement(updateSql);
