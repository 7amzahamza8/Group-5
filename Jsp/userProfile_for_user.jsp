...
<%
    ...
    try {
        ...
        if (rs.next()) {
            ...
            out.println("<div class='error-message'>the user not available.</div>");
            return;
        }
...
<div class="profile-container">
    <div class="profile-card">
        ...
        <div class="profile-detail">
            <strong>Phone:</strong> <%= phone.isEmpty() ? "Not provided" : phone %>
        </div>
        
        <div class="profile-detail">
            <strong>WhatsApp:</strong> <%= (whatsapp == null || whatsapp.isEmpty()) ? "Not provided" : whatsapp %>
        </div>
